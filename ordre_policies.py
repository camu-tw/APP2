def ordre_policies(l_copie):
    p1=input("quel est la policy la plus importante parmis : diplomatic, medical, technical ?") 
    if p1=="diplomatic" : 
        for i in l_copie : 
    ...
    p2=input("quel est la policy la plus importante parmis : diplomatic, medical, technical ?")
    if p1==p2 : 
